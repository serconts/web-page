<template>
  <div class="layout">
    ...
    <footer id="footer">
      ...
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong>SERCONTS S.A.C.</strong> Todos los derechos
          reservados
        </div>
        <div class="credits">
          Diseñado con 💚 por <a href="https://serconts.com/">SERCONTS S.A.C</a>
        </div>
      </div> </footer
    ><!-- End Footer -->
  </div>
